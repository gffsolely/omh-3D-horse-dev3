...
//import TrackSantaArenaModel from '@/views/raceTrack3D/TrackSantaArenaModelTs1';
...
//   const horseRaceArenaModel = config.fileHost3d + '/omh-game/models/model/202308/05/horse_race_arena_santa_v0.3.glb';
...
//       const model = obj.scene;
//       // model.position.set(130, 19, 220);
//       //model.position.set(150, 19.3, -40);
...
//                 // xa: cyaPre + cyaDiff * index3,
//                 // ya: 1,
//                 // za: cxaPre + cxaDiff * index3,
//                 t: pathPre.t,
//                 r: pathPre.direction,
...
//     HorseRunModelObjs.forEach((obj, idx) => {
...
//         actionHorseRun.setDuration(animationIdx === 1 ? 2 : 1.5);
//         actionHorseRun.play();
