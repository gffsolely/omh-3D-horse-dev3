...
const defaultMeta = {
  title: 'omnihorse',
  siteName: 'omnihorse omnihorse',
  description:
    'omnihorse, Seo, Link omnihorse, www omnihorse',
  /** Without additional '/' on the end, e.g. https://theodorusclarence.com */
  url: 'https://omnihorse.io',
  type: 'website',
  robots: 'follow, index',
  /**
   ...
   */
  image: 'https://avatars.githubusercontent.com/u/112422062?v=4',
};
...
const favicons: Array<React.ComponentPropsWithoutRef<'link'>> = [
  {
    ...
    sizes: '180x180',
    href: 'https://avatars.githubusercontent.com/u/112422062',
  },
  {
    rel: 'icon',
    type: 'image/png',
